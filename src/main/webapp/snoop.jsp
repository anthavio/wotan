...
<TR valign=top>
	<TD><%= entry.getKey() %></TD>
	<TD><%= (key.contains("password") || key.toLowerCase().contains("secret"))? "*******": entry.getValue() %></TD>
</TR>
<%		
	}
%>
...
<TR valign=top>
	<TD><%= key %></TD>
	<TD><%= (key.toLowerCase().contains("password") || key.toLowerCase().contains("secret"))? "*******": entry.getValue() %></TD>
</TR>
<%		
	}
%>
